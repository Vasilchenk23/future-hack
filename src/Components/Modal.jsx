...
const combinedStyles = [
  { textColor: '#000000', backgroundColor: '#CC0000' },
  { textColor: '#330099', backgroundColor: '#CC0000' }, 
  ...
  { textColor: '#000000', backgroundColor: '#FF6600' }, 
  ...
  { textColor: '#000000', backgroundColor: '#FFFF00' }, 
  ...
  { textColor: '#000000', backgroundColor: '#009900' },
  ...
  { textColor: '#000000', backgroundColor: '#00CCCC' }, 
  ...
  { textColor: '#000000', backgroundColor: '#0066FF' }, 
  ...
  { textColor: '#000000', backgroundColor: '#330099' }, 
  ...
  { textColor: '#FFFFFF', backgroundColor: '#330099' },  
  ...
  return (
    <div className="modal">
      <h2 className='title-modal'>Налаштування для користувачів з обмеженими можливостями зору</h2>
          ...
          <div className="color-options">
            {combinedStyles.map((style, index) => (
              <button
                ...
                style={{ backgroundColor: style.backgroundColor, color: style.textColor, margin: '5px' }}
