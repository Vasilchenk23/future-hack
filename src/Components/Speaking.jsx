...
const Speaking = () => {
  ...
  useEffect(() => {
    const searchWords = ["travel", "ball", "fruit", "vegetables"];
  ...
  return (
    <>
      <div className="main" style={{ color: textColor, fontSize: `${fontSize}px` }}>
        <div className="white-block">
          <div className="item-header-block">
            ...
            <Link to="/goals" style={{ color: textColor }}>
              ...
              strokeLinecap="round"  strokeLinejoin="round" className="arrow-left-speak">
          ...
          <svg className="logo-speak" width="160" height="160" viewBox="0 0 160 160" stroke="currentColor" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="black-block-speak" style={{ backgroundColor: textColor}}>
          {icons.map((icon, index) => (
            <Link key={index} to="/lesson">
              <div className="block-travel" style={{ backgroundColor: textColor}}>
