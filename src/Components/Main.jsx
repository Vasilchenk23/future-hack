    ...
    <>
      <div className="main" style={{ color: textColor, fontSize: `${fontSize}px` }}>
        <div className="white-block" style={{ backgroundColor: '#ffffff' }}>
          ...
          <svg className="logo" width="160" height="160" viewBox="0 0 160 160" stroke="currentColor" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="black-block" style={{ backgroundColor: textColor}} >
          <Link to="/level">
